...
export const ROLE_PERMISSIONS = {
  ...
  'admin': [
    'management.access', 'dashboard.view', 'employees.view', 'employees.create', 'employees.edit',
    'inventory.access', 'products.view', 'products.create', 'products.edit',
    'financial.access', 'ledger.view', 'transactions.view', 'funds.view',
    'marketing.access', 'promotions.view', 'campaigns.view',
    'b2b.access', 'quotes.view', 'quotes.create',
  ],

  'sales-manager': [
    'pos.access', 'sales.create', 'sales.view', 'sales.edit',
    'b2b.access', 'quotes.view', 'quotes.create', 'quotes.edit',
    'customers.segment', 'marketing.dashboard',
  ],

  'sales-staff': [
    'pos.access', 'sales.create', 'sales.view',
    'b2b.access', 'quotes.view', 'quotes.create',
  ],

  'medical-staff': [
    'medical.access', 'patients.view', 'patients.create', 'patients.edit',
    'appointments.view', 'appointments.create', 'appointments.edit',
    'medical-records.view', 'medical-records.create',
  ],
  ...
  'marketing-manager': [
    'marketing.access', 'marketing.dashboard', 'promotions.view', 'promotions.create',
    'vouchers.view', 'vouchers.create', 'campaigns.view', 'campaigns.create',
    'customers.segment', 'content.manage', 'chatbot.manage',
  ],

  'accountant': [
    'financial.access', 'ledger.view', 'ledger.edit', 'transactions.view', 'transactions.create',
    'funds.view',
  ],
};
...
export const hasScreenPermission = (screenKey: string, userPermissions: string[]): boolean => {
  ...
  return screen.permissions.every(permission => userPermissions.includes(permission));
};

// Helper function to get available screens for user
export const getAvailableScreens = (userPermissions: string[]): Record<string, ScreenConfig> => {
  return Object.entries(SCREEN_REGISTRY)
